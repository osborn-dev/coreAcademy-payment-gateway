      ...
      <div className="w-full">
        ...
        >
          ...
          <div className="space-y-10 text-gray-700 dark:text-gray-300 text-base sm:text-lg leading-relaxed">
            ...
            <motion.section variants={sectionVariants} initial="initial" animate="animate">
              <div className="flex items-center gap-3 mb-3">
                <FontAwesomeIcon icon={faUserCheck} className="text-blue-600 dark:text-blue-400 text-base" />
                <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 dark:text-gray-100">1. Eligibility</h2>
              </div>
            ...
            <motion.section variants={sectionVariants} initial="initial" animate="animate">
              <div className="flex items-center gap-3 mb-3">
                <FontAwesomeIcon icon={faCreditCard} className="text-blue-600 dark:text-blue-400 text-base" />
                <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 dark:text-gray-100">2. Payments and Refunds</h2>
              </div>
              <p>
            ...
            <motion.section variants={sectionVariants} initial="initial" animate="animate">
              <div className="flex items-center gap-3 mb-3">
                <FontAwesomeIcon icon={faKey} className="text-blue-600 dark:text-blue-400 text-base" />
                <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 dark:text-gray-100">3. Access and Usage</h2>
              </div>
              <p>
            ...
            <motion.section variants={sectionVariants} initial="initial" animate="animate">
              <div className="flex items-center gap-3 mb-3">
                <FontAwesomeIcon icon={faUsers} className="text-blue-600 dark:text-blue-400 text-base" />
                <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 dark:text-gray-100">4. Code of Conduct</h2>
              </div>
              <p>
            ...
            <motion.section variants={sectionVariants} initial="initial" animate="animate">
              <div className="flex items-center gap-3 mb-3">
                <FontAwesomeIcon icon={faCopyright} className="text-blue-600 dark:text-blue-400 text-base" />
                <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 dark:text-gray-100">5. Intellectual Property</h2>
              </div>
              <p>
            ...
            <motion.section variants={sectionVariants} initial="initial" animate="animate">
              <div className="flex items-center gap-3 mb-3">
                <FontAwesomeIcon icon={faCommentDots} className="text-blue-600 dark:text-blue-400 text-base" />
                <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 dark:text-gray-100">6. Community Contributions</h2>
              </div>
              <p>
            ...
            <motion.section variants={sectionVariants} initial="initial" animate="animate">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 dark:text-gray-100">7. Changes to These Terms</h2>
              </div>
              <p>
            ...
            <motion.section variants={sectionVariants} initial="initial" animate="animate">
              <div className="flex items-center gap-3 mb-3">
                <FontAwesomeIcon icon={faHeart} className="text-blue-600 dark:text-blue-400 text-base" />
                <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 dark:text-gray-100">8. Social Impact</h2>
              </div>
              <p>
            ...
            <motion.section variants={sectionVariants} initial="initial" animate="animate">
              <div className="flex items-center gap-3 mb-3">
                <FontAwesomeIcon icon={faEnvelope} className="text-blue-600 dark:text-blue-400 text-base" />
                <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 dark:text-gray-100">9. Contact</h2>
              </div>
              <p>
